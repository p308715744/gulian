...
function get_informations($type, $zituan_info, $id = 0, $dj = 0, $user_name = '', $flag = '') {
	...
	if($type == "zituan"){
		...
		if($zituan_info['kind'] == '台湾') $tichenglv = 50;
		elseif($zituan_info['kind'] == '日本') $tichenglv = 20;
		elseif($zituan_info['kind'] == '欧美岛') $tichenglv = 100;
		elseif($zituan_info['kind'] == '韩国') $tichenglv = 20;
		elseif($zituan_info['kind'] == '港澳') $tichenglv = 20;
		elseif($zituan_info['kind'] == '东南亚') $tichenglv = 20;
		elseif($zituan_info['kind'] == '长线游') $tichenglv = 10;
		elseif($zituan_info['kind'] == '短线游') $tichenglv = 5;
		
		if($dj) $tichenglv = 0;
		
		$zituan_info['ticheng'] = $zituan_info['caozuorenshu'] * $tichenglv;	
...
/*		$zituan_info['dingdanshu'] = $dingdan_num;
		...
		$zituan_info['ticheng'] = $zituan_info['caozuorenshu'] * 2;	
	...
	if($type == "dingdan"){
		...
		if($zituan){
			if($zituan['kind'] == '台湾') $zituan_info['tichenglv'] = 10;
			elseif($zituan['kind'] == '日本') $zituan_info['tichenglv'] = 5;
			elseif($zituan['kind'] == '欧美岛') $zituan_info['tichenglv'] = 20;
			elseif($zituan['kind'] == '韩国') $zituan_info['tichenglv'] = 5;
			elseif($zituan['kind'] == '港澳') $zituan_info['tichenglv'] = 5;
			elseif($zituan['kind'] == '东南亚') $zituan_info['tichenglv'] = 5;
			elseif($zituan['kind'] == '长线游') $zituan_info['tichenglv'] = 5;
			elseif($zituan['kind'] == '短线游') $zituan_info['tichenglv'] = 2;
		}
